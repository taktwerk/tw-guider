...
class _InstructionStepViewState extends State<InstructionStepOverview> {
  ...
  void initState() {
    super.initState();
    initializeStepViews();
    selectedItem = "Step ${widget.steps[0].stepNr}";
  }
                ...
                children: [
                  _items.indexOf(selectedItem!) != 0
                      ? ElevatedButton.icon(
                          ...
                          onPressed: () {
                            setState(() {
                              var index = (_items.indexOf(selectedItem!) - 1) %
                                  _items.length;
                      ...
                      : Container(),
                  _items.indexOf(selectedItem!) != _items.length - 1
                      ? Directionality(
