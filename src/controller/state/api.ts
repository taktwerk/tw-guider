...
const api: any = {
  endpoints: {
    ...
    zones_get: {
      requestType: 'get',
      url: '/zones?user_id={{user_id}}&site={{site}}'
    },
    ...
    packagingList: {
      requestType: 'get',
      url: '/analyze_packaging_line_dropdown?user_id={{user_id}}&site={{site}}&mapping_type={{mapping_type}}'
    },
    ...
    raw_material_cards: {
      requestType: 'get',
      url: '/raw_material_cards?user_id={{user_id}}&cut_off_type={{cut_off_type}}'
    },
    ...
    //don't want update_custome_reports to be called
    ...
    admin_zones_put: {
      requestType: 'put',
      url: '/admin_zone_packaging_update?user_id={{user_id}}&site={{site}}&mapping_type={{mapping_type}}'
    },
    admin_zones_delete: {
      requestType: 'delete',
      url: '/admin_zone_packaging_update?user_id={{user_id}}&site={{site}}&mapping_type={{mapping_type}}'
    ...
    labor_modeling_get: {
      requestType: 'get',
      url: '/labor_modeling_get?user_id={{user_id}}&scenario={{scenario}}&mapping_type={{mapping_type}}'
    },
    labor_modeling_calculate: {
      requestType: 'post',
      url: '/labor_modeling_cal?user_id={{user_id}}&scenario={{scenario}}&mapping_type={{mapping_type}}'
    },
    labor_modeling_approve: {
      requestType: 'post',
      url: '/labor_modeling_approve?user_id={{user_id}}&scenario={{scenario}}&mapping_type={{mapping_type}}'
    },
    //user-logs
    user_logs: {
      requestType: 'post',
      url: '/screen_time_tracking?user_id={{user_id}}&site={{site}}'
    },
    user_Types: {
      requestType: 'get',
      url: '/user_type_dropdown?user_id={{user_id}}&site={{site}}'
    },
    site_types: {
      requestType: 'get',
      url: '/site_dropdown?user_id={{user_id}}&site={{site}}'
    },
    user_chart_data:{
      requestType: 'post',
      url: '/application_usage_statistics?user_id={{user_id}}&site={{site}}'
    }
  },
